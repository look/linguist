RB_SYS_BUILD_DIR ?= /Users/look/github/look-linguist/.rb-sys
CARGO ?= cargo
CARGO_BUILD_TARGET ?= 
SOEXT ?= dylib
...
RB_SYS_CARGO_MANIFEST_DIR ?= /Users/look/.rbenv/versions/3.4.5/bin
...
target_prefix = /linguist
TARGET_NAME = linguist_rs
...
srcdir = /Users/look/.rbenv/versions/3.4.5/bin
topdir = /Users/look/.rbenv/versions/3.4.5/include/ruby-3.4.0
hdrdir = $(topdir)
arch_hdrdir = /Users/look/.rbenv/versions/3.4.5/include/ruby-3.4.0/arm64-darwin24
PATH_SEPARATOR = :
VPATH = $(srcdir):$(arch_hdrdir)/ruby:$(hdrdir)/ruby

prefix = $(DESTDIR)/Users/look/.rbenv/versions/3.4.5
...
export RBCONFIG_TEENY := 5
export RBCONFIG_PATCHLEVEL := 51
export RBCONFIG_INSTALL := /opt/homebrew/bin/ginstall -c
export RBCONFIG_EXEEXT := 
export RBCONFIG_prefix := /Users/look/.rbenv/versions/3.4.5
...
export RBCONFIG_vendorarchhdrdir := /Users/look/.rbenv/versions/3.4.5/include/ruby-3.4.0/vendor_ruby/arm64-darwin24
export RBCONFIG_sitearchhdrdir := /Users/look/.rbenv/versions/3.4.5/include/ruby-3.4.0/site_ruby/arm64-darwin24
export RBCONFIG_rubyarchhdrdir := /Users/look/.rbenv/versions/3.4.5/include/ruby-3.4.0/arm64-darwin24
export RBCONFIG_vendorhdrdir := /Users/look/.rbenv/versions/3.4.5/include/ruby-3.4.0/vendor_ruby
export RBCONFIG_sitehdrdir := /Users/look/.rbenv/versions/3.4.5/include/ruby-3.4.0/site_ruby
export RBCONFIG_rubyhdrdir := /Users/look/.rbenv/versions/3.4.5/include/ruby-3.4.0
export RBCONFIG_RUBY_SEARCH_PATH := 
export RBCONFIG_UNIVERSAL_INTS := 
export RBCONFIG_UNIVERSAL_ARCHNAMES := 
export RBCONFIG_configure_args := '--prefix=/Users/look/.rbenv/versions/3.4.5' '--with-openssl-dir=/opt/homebrew/opt/openssl@3' '--enable-shared' '--with-libyaml-dir=/opt/homebrew/opt/libyaml' '--with-gmp-dir=/opt/homebrew/opt/gmp' '--with-ext=openssl,psych,+' 'CC=clang'
export RBCONFIG_CONFIGURE := configure
export RBCONFIG_vendorarchdir := /Users/look/.rbenv/versions/3.4.5/lib/ruby/vendor_ruby/3.4.0/arm64-darwin24
export RBCONFIG_vendorlibdir := /Users/look/.rbenv/versions/3.4.5/lib/ruby/vendor_ruby/3.4.0
export RBCONFIG_vendordir := /Users/look/.rbenv/versions/3.4.5/lib/ruby/vendor_ruby
export RBCONFIG_sitearchdir := /Users/look/.rbenv/versions/3.4.5/lib/ruby/site_ruby/3.4.0/arm64-darwin24
export RBCONFIG_sitelibdir := /Users/look/.rbenv/versions/3.4.5/lib/ruby/site_ruby/3.4.0
export RBCONFIG_sitedir := /Users/look/.rbenv/versions/3.4.5/lib/ruby/site_ruby
export RBCONFIG_rubyarchdir := /Users/look/.rbenv/versions/3.4.5/lib/ruby/3.4.0/arm64-darwin24
export RBCONFIG_rubylibdir := /Users/look/.rbenv/versions/3.4.5/lib/ruby/3.4.0
export RBCONFIG_ruby_version := 3.4.0
export RBCONFIG_sitearch := arm64-darwin24
export RBCONFIG_arch := arm64-darwin24
export RBCONFIG_sitearchincludedir := /Users/look/.rbenv/versions/3.4.5/include/arm64-darwin24
export RBCONFIG_archincludedir := /Users/look/.rbenv/versions/3.4.5/include/arm64-darwin24
export RBCONFIG_sitearchlibdir := /Users/look/.rbenv/versions/3.4.5/lib/arm64-darwin24
export RBCONFIG_archlibdir := /Users/look/.rbenv/versions/3.4.5/lib/arm64-darwin24
export RBCONFIG_libdirname := libdir
export RBCONFIG_RUBY_EXEC_PREFIX := /Users/look/.rbenv/versions/3.4.5
export RBCONFIG_RUBY_LIB_VERSION := 
export RBCONFIG_RUBY_LIB_VERSION_STYLE := 3	/* full */
export RBCONFIG_RI_BASE_NAME := ri
export RBCONFIG_ridir := /Users/look/.rbenv/versions/3.4.5/share/ri
export RBCONFIG_rubysitearchprefix := /Users/look/.rbenv/versions/3.4.5/lib/ruby/arm64-darwin24
export RBCONFIG_rubyarchprefix := /Users/look/.rbenv/versions/3.4.5/lib/ruby/arm64-darwin24
...
export RBCONFIG_rubylibprefix := /Users/look/.rbenv/versions/3.4.5/lib/ruby
...
export RBCONFIG_EGREP := /opt/homebrew/bin/ggrep -E
export RBCONFIG_GREP := /opt/homebrew/bin/ggrep
...
export RBCONFIG_RUBY_PROGRAM_VERSION := 3.4.5
...
export RBCONFIG_mandir := /Users/look/.rbenv/versions/3.4.5/share/man
export RBCONFIG_localedir := /Users/look/.rbenv/versions/3.4.5/share/locale
export RBCONFIG_libdir := /Users/look/.rbenv/versions/3.4.5/lib
export RBCONFIG_psdir := /Users/look/.rbenv/versions/3.4.5/share/doc/ruby
export RBCONFIG_pdfdir := /Users/look/.rbenv/versions/3.4.5/share/doc/ruby
export RBCONFIG_dvidir := /Users/look/.rbenv/versions/3.4.5/share/doc/ruby
export RBCONFIG_htmldir := /Users/look/.rbenv/versions/3.4.5/share/doc/ruby
export RBCONFIG_infodir := /Users/look/.rbenv/versions/3.4.5/share/info
export RBCONFIG_docdir := /Users/look/.rbenv/versions/3.4.5/share/doc/ruby
export RBCONFIG_oldincludedir := /usr/include
export RBCONFIG_includedir := /Users/look/.rbenv/versions/3.4.5/include
export RBCONFIG_runstatedir := /Users/look/.rbenv/versions/3.4.5/var/run
export RBCONFIG_localstatedir := /Users/look/.rbenv/versions/3.4.5/var
export RBCONFIG_sharedstatedir := /Users/look/.rbenv/versions/3.4.5/com
export RBCONFIG_sysconfdir := /Users/look/.rbenv/versions/3.4.5/etc
export RBCONFIG_datadir := /Users/look/.rbenv/versions/3.4.5/share
export RBCONFIG_datarootdir := /Users/look/.rbenv/versions/3.4.5/share
export RBCONFIG_libexecdir := /Users/look/.rbenv/versions/3.4.5/libexec
export RBCONFIG_sbindir := /Users/look/.rbenv/versions/3.4.5/sbin
export RBCONFIG_bindir := /Users/look/.rbenv/versions/3.4.5/bin
export RBCONFIG_exec_prefix := /Users/look/.rbenv/versions/3.4.5
...
export RBCONFIG_archdir := /Users/look/.rbenv/versions/3.4.5/lib/ruby/3.4.0/arm64-darwin24
export RBCONFIG_topdir := .
export RBCONFIG_srcdir := /Users/look/.rbenv/versions/3.4.5/bin
...
$(RUSTLIB): FORCE
	...
	$(CARGO) rustc $(RB_SYS_EXTRA_CARGO_ARGS) --manifest-path $(RB_SYS_CARGO_MANIFEST_DIR)/Cargo.toml --target-dir $(RB_SYS_CARGO_TARGET_DIR) --lib $(RB_SYS_CARGO_PROFILE_FLAG) -- -C linker=clang -L native=/Users/look/.rbenv/versions/3.4.5/lib -L native=/opt/homebrew/Cellar/gmp/6.3.0/lib -C link-arg=-Wl,-undefined,dynamic_lookup -l pthread
